...
| (C) **E (E letter)**                 | Red border, grey filling, E letter | Amber border + amber filling, E letter | Green border + green filling, E letter | X                                      | X                                      | X                                      | X                            |
| (C) **T (T letter)**                 | Red border, grey filling, T letter | Amber border + amber filling, T letter | Green border + green filling, T letter | X                                      | X                                      | X                                      | X                            |
| (C) **L (L letter)**                 | Red border, grey filling, L letter | Amber border + amber filling, L letter | Green border + green filling, L letter | X                                      | X                                      | X                                      | X                            |
| (C) **NONE (-)**                     | Red border, grey filling, -        | Amber border + amber filling, dash (-) | Green border + green filling, dash (-) | X                                      | X                                      | X                                      | X                            |
